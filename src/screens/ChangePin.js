                ...
                <View className={`bg-[#293462] p-8 flex justify-end h-full rounded-b-3xl`}>
                    <TouchableOpacity onPress={() => navigation.navigate('Profile')}>
                        <View className={`w-full flex flex-row items-center space-x-2`}>
                            ...
                            <Text className={`text-[#DBDFFD] font-bold text-base`}>Change PIN</Text>
                        </View>
                    </TouchableOpacity>
                </View>
            </View>
            <View className={`p-4 bg-gray-100 flex flex-col justify-center flex-1 space-y-4`}>
                <Text className={`text-[#8289AF] text-sm text-center`}>Enter your current 6 digits Zwallet PIN below to continue to the next steps.</Text>
                ...
                <TouchableOpacity className={`w-full`} onPress={() => navigation.navigate('ChangePinConfirm')}>
